...
<!-- <div class="print-container"> -->
		...
		<div style="width:49%;float:left">
			...
			<div class="print-sect">
				<table>
					<tr>
						<td>Name:</td>
						<td class="print-val"><?=$result_obj->facility['facility']?></td>
					</tr>
					<tr>
						<td>District:</td>
		...
		<div style="width:49%;float:left" >	
			...
			<div class="print-sect2">			
				<table cellspacing="3">
					<tr>
						<td>ART Number: &nbsp;</td>
						<td class="print-val"><?=$result_obj->patient['art_number'] ?></td>
					</tr>
					<tr>
						<td>Other ID:</td>
						<td class="print-val"><?=$result_obj->patient['other_id'] ?></td>
					</tr>
					<tr>
						<td>Sex:</td>
						<td class="print-val-check"><?=MyHTML::boolean_draw($genders, $result_obj->patient['gender'])?></td>
					</tr>
					...
					<div style="width:79%;float:left">
						<table cellspacing="4">
							...
							<tr>
								...
								<td ><?=$result_obj->result['result_alphanumeric'] ?></td>
							</tr>
						</table>		
	...
	<footer><span style='float:left'>"a SANAS Accredited Medical Laboratory, No. M0589"</span> <span style='float:right'>{{ $print_version }} &nbsp;&nbsp;1 of 1</span></footer>
</page>
<!-- </div> -->
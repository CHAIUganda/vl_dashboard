...
class AruaNewFormat extends Command
{
    ...
    private function getAruaData(){
        ...
        $file = fopen("/Users/simon/Documents/Documents/METS/CBS/CPHL/AruaData/Sep2017Submission.csv", "r");
    ...
    */
    ...
    private function getPregnancyStatus($sample_record){
        ...
        if(strpos(strtolower($sample_record), strtolower('yes')) ){
          $pregnancy_status = "Yes";
      }elseif (strpos(strtolower($sample_record), strtolower('no'))) {
           $pregnancy_status = "No";
      }
